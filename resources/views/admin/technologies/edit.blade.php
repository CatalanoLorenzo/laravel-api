            ...
            <form action="{{route('admin.technologies.update', $technology)}}" method="post" enctype="multipart/form-data">
                ...
                @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" id="name" aria-describedby="helpId" value="{{old('name', $technology->name)}}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="cover" id="cover" aria-describedby="helpId" value="{{old('cover',$technology->cover)}}">
                    </div>
